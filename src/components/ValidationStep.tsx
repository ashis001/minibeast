...
const ValidationStep = ({ onNext, snowflakeConfig }: ValidationStepProps) => {
  ...
  const loadAvailableTables = async () => {
    ...
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/tables', {
        method: 'POST',
        headers: {
  ...
  const createConfigTable = async () => {
    ...
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/create-config-table', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSubmitValidation = async () => {
    ...
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/insert-validation', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
