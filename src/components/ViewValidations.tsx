...
const ViewValidations = ({ snowflakeConfig, onNavigate }: ViewValidationsProps) => {
  ...
  const loadEntities = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/entities', {
        method: 'POST',
        headers: {
  ...
  const loadDescriptions = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/descriptions', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const loadValidations = async () => {
    setIsLoading(true);
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/validations-filtered', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const saveActivationChanges = async () => {
    setIsSaving(true);
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/update-validations', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateValidation = async (updatedValidation: ValidationRule) => {
    setIsUpdating(true);
    try {
      const response = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/snowflake/update-validation', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const runValidations = async () => {
    ...
    try {
      ...
      const validationResponse = await fetch('https://goat-attach-grid-adaptive.trycloudflare.com/api/stepfunction/execute', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
